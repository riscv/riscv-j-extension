...
[NOTE]
====
It is worth noting that Pointer Masking is not applied to SFENCE.\*, HFENCE.*, SINVAL.\*, or HINVAL.*. When such operation is invoked, it is the responsibility of software to provide the correct address.
====
